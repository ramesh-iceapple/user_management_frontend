...
export const MemberAdminEmailText = styled.span`
  color: #adadad;
  font-family: Inter;
  font-size: 12px;
  font-style: normal;
...
export const MemberSuccessStatus = styled.div`
  border-radius: 21px;
  background: #e4ffe7;
  padding: 5px;
  text-align: center;
...
export const DownLoadMemberButton = styled(SecondaryLinkButton)`
  font-family: Inter;
  font-size: 14px;
  font-style: normal;
  font-weight: 500;
...
export const MemberHint = styled(Row)`
  color: #828282;
  font-family: Inter;
  font-size: 14px;
  font-style: normal;
...
export const DownLoadAllButton = styled(SecondaryButton)`
  min-width: 179px;
  min-height: 36px;
`;

export const MemberPdfImage = styled(Image)`
  width: 18px;
  height: 18px;
  margin-right: 3px;
`;
